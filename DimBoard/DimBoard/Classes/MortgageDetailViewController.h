...
@interface MortgageDetailViewController : UIViewController<UITableViewDataSource,UITableViewDelegate, PieChartCellExtendDelegate, UINavigationControllerDelegate, ADBannerViewDelegate>
