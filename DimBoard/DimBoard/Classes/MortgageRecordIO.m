...
-(id)initWithLoadRecords{
    ...
    if(self){
        m_maxId = -1;
        m_plistpath = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0] stringByAppendingPathComponent:RECORDPLISTFILENAME];
